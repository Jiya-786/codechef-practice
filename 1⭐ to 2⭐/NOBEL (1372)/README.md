...
## N researchers which the community who will be considered for the prize, and the topics in which each of them work.

## 

## In total the CS field can be divided into 

## M

## M broad topics. Given the topics in which each of the 

## N

## N researchers are working on, in the form of an array 

## A

## A, and given that Chef can master any topic instantly, find whether he can win the prize. That is, can the Chef choose to work on some topic which will guarantee that he will win the prize? Chef doesn't mind sharing the prize with others.
...
## M, number of researchers excluding Chef and total number of fields respectively.
