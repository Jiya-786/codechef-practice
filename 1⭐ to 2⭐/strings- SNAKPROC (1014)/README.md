...
## R, which denotes the number of reports to be checked. The description of each report follows after this.

## The first line of each report contains a single integer, 

## L

## L, the length of that report.

## The second line of each report contains a string of length 

## L

## L. The string contains only the characters '.', 'H', and 'T'.
